...
<title>登录|雏鹰网络成员信息管理系统</title>
<meta name="keywords" content="学生信息管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">雏鹰网络社团信息管理系统</h2>
</div>
...
<div class="footer">Copyright &nbsp; artisan @ 雏鹰网络社团</div>
